...
if __name__ == '__main__':
    file = '/Users/azen/Desktop/myAir/Work/Workspace/Others/DeepLearning-Tutorial/1.Prerequisites/1.4.LinearRegression/datasets/ShanghaiHousePrices.csv'
    num_features = 6
    batch_size = 64
